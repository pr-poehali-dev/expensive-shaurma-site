...
const Index = () => {
  ...
  const menuItems = [
    ...
    {
      name: 'Царская шаурма Элит',
      price: 5000,
      priceText: '5 000 ₽',
      description: 'Мраморное мясо высшего сорта, трюфельная заправка, салаты с пармезаном. Для истинных ценителей',
      weight: '450г',
      category: 'shawarma'
    },
    {
      name: 'Царская шаурма Империал',
      price: 10000,
      priceText: '10 000 ₽',
      description: 'Эксклюзивное мясо с золотой фольгой, фуа-гра, трюфельный крем, салаты с икрой. Вершина кулинарного искусства',
      weight: '500г',
      category: 'shawarma'
    }
  ];
